...
module "iam" {
  ...
  published_data_product_tables      = var.enable_federated_governance ? [] : var.published_data_product_tables
  published_data_product_s3_prefixes = var.enable_federated_governance ? [] : var.published_data_product_s3_prefixes
